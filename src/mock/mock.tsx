...
export const mockItemSummary: Mock = (config) => {
  ...
  if (group_by === "happend_at" && kind === "expenses") {
    return [
      200,
      {
        groups: [
  ...
  } else if (group_by === "happend_at" && kind === "income") {
    return [
      200,
      {
        groups: [
          { happend_at: "2023-01-08T00:00:00.000+0800", amount: 100 },
          { happend_at: "2023-01-12T00:00:00.000+0800", amount: 300 },
          { happend_at: "2023-01-19T00:00:00.000+0800", amount: 200 },
        ],
        summary: 600,
      },
    ]
